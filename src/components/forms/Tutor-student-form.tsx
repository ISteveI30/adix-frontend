...
const formSchema = z.object({
  ...
  phone1: z.string().min(9, "Teléfono obligatorio").max(15, "Teléfono inválido"),
  ...
  studentEmail: z.string().email("Correo inválido"),
...
const TutorStudentForm: FC<TutorStudentFormProps> = ({ onSave, initialData, onCancel }: TutorStudentFormProps) => {
  ...
  const tutorFields: FormField[] = [
    ...
    { label: "Teléfono 1", name: "phone1", required: true },
